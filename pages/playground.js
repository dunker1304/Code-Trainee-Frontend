...
const Playground = props => { 
  ...
  const [consoleEditor, setConsoleEditor] = useState('hide')
  ...
  return (
    <>
      <Row>
        ...
        <Col className="content-left playground-wrapper" span={14}>
...

          {
            ...
            :
            <div className="console-status" style={ (consoleEditor == 'hide') ? {display: 'none'} : '' }>
      ...
      <Row className="footer-playground">
        <Col span={10} className="question-fast-picker">
          <Button type='default'>
        ...
        <Col span={14} className="action-code-editor">
          <Button className="show-console">
            <span>Console</span>
